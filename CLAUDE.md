...
- **Ratified dataset #3 (Tier 1) — human-capital productivity.** PhDs produced / researchers trained per research dollar (NSF GSS — GSS-first, SED deferred as person-grain); NCSES-native, shared keyspace. Selected as the next dataset; acquisition blocked on NSF availability (2026-05-31), the HD 4.1 gate-spike ready on resumption (see *Roadmap* above).

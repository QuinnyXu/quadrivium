...
4. **Methods-note paragraphs at HD 2.4.i (items 5, 6, 7).** **RESOLVED.** Confirmed for HD 2.4.i: rollup-vs-leaf double-counting paragraph (item 5 / §14.3); pre-1981 fingerprint footnote (item 6 / §14.4); equipment-series `source_class='all_source'` asymmetry note (item 7 / §14.5). All locked into the §10 timeline at HD 2.4.i (+0.25 half-day).
